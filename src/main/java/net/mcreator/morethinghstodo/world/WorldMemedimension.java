...
package net.mcreator.morethinghstodo.world;
...
import net.mcreator.morethinghstodo.item.ItemMemedimension;
import net.mcreator.morethinghstodo.block.BlockEdenrichardsblock;
...
public class WorldMemedimension extends ElementsMorethinghstodoMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("morethinghstodo:memedimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldMemedimension(ElementsMorethinghstodoMod instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemMemedimension().setUnlocalizedName("memedimension").setRegistryName("memedimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension memedimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("memedimension", "_memedimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemMemedimension.block, 0,
				new ModelResourceLocation("morethinghstodo:memedimension", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockEdenrichardsblock.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockEdenrichardsblock.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("memedimension_portal");
			setRegistryName("memedimension_portal");
			setLightLevel(1F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockEdenrichardsblock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockEdenrichardsblock.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockEdenrichardsblock.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockEdenrichardsblock.block
