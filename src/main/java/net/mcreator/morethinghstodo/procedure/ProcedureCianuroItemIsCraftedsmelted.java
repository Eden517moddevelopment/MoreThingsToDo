package net.mcreator.morethinghstodo.procedure;
...
public class ProcedureCianuroItemIsCraftedsmelted extends ElementsMorethinghstodoMod.ModElement {
	public ProcedureCianuroItemIsCraftedsmelted(ElementsMorethinghstodoMod instance) {
		super(instance, 7);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure CianuroItemIsCraftedsmelted!");
			return;
		}
